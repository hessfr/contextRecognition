...
"""
from __future__ import division #adopt behavior from Python 3 -> 5/2 returns 2.5 and 5//2 returns 2
...
class LOF:
    ...
    def normalize_instance(self, instance):
        return tuple(map(lambda value,max,min: (value-min)/(max-min), instance, self.max_attribute_values, self.min_attribute_values))
